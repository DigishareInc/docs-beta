...
::accordion
::accordion-item{label="Nouvelle Conversation" icon="i-mdi-plus"}
...
::accordion-item{label="Message Entrant" icon="i-mdi-arrow-bottom-left"}
...
body:
  ...
  conversation_id: "VOUS_AVEZ_L_ID"
  send_to_third: true
---
::
