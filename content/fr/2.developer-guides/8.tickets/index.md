...
body:
  ...
  comment: L'utilisateur ne parvient pas à se connecter à son espace client.
  third_id: thd_123456
---
::
...
body:
  ...
  note: En cours de traitement par le support technique.
---
::
...
method: GET
url: https://api.digishare.ma/v1/tickets
description: Lister les tickets avec filtres optionnels.
variables:
  token: VOTRE_TOKEN
headers:
  Authorization: Bearer {token}
