...
::
::card{title="Incoming Messages" icon="i-lucide-download" to="/developer-guides/livechat/incoming-messages"}
Understand how to receive and parse messages from customers (Text, Location, Buttons).
::
